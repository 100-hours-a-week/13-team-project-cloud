...
> 상세 설정 방법은 [배포 상세 절차 - E. 프로세스 관리 설정](./.github/cloud/docs/step1/reference-deployment-details.md#e-프로세스-관리-설정)을 참고하세요.
...
<!-- | [배포 상세 절차](./.github/cloud/docs/step1/reference-deployment-details.md)               | 배포 개요, 준비사항 체크리스트, 롤백 절차, **프로세스 관리 설정 (systemd/pm2)**, GPU 서버 배포 |
| [문제 시나리오 및 개선 계획](./.github/cloud/docs/step1/reference-improvement-plan.md)     | 구체적 문제 시나리오, 임계점, 단계별 개선 로드맵                                               |
| [RunPod 배포 방식 상세](./.github/cloud/docs/step1/reference-runpod-deployment-methods.md) | GPU Serverless 배포 방법, VLM 비용 비교, 손익분기점 분석                                       |
